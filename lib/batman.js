(function() {
  ...
  Batman.Association.belongsTo = (function() {
    __extends(belongsTo, Batman.SingularAssociation);
    ...
    belongsTo.prototype.url = function(recordOptions) {
  ...
  Batman.Association.hasOne = (function() {
    __extends(hasOne, Batman.SingularAssociation);
  ...
  Batman.Association.hasMany = (function() {
    __extends(hasMany, Batman.PluralAssociation);
